		...
		steps {
			...
			bashNodeScript {
				...
				scriptContent = """
					...
					for i in {1..100}; do xvfb-run yarn jest --reporters=jest-teamcity --reporters=default --maxWorkers=%E2E_WORKERS% specs/specs-playwright/wp-notifications__trash; done
				""".trimIndent()
				dockerImage = "%docker_image_e2e%"
			}
			bashNodeScript {
